...
<p align="center">
  <img src="LEXOLEN-logo.gif" width="180" alt="LEXOLEN Logo">
</p>
...
|------|-------------|------|
| **Evil‑ginx3** | Advanced phishing framework with 2FA bypass | [GitHub](https://github.com/LEXOLEN/evil-ginx3) (Release v3.1.0, commit hash: a1b2c3d4e5f678901234567890abcdef12345678) |
| **BloodHound‑CE** | Active Directory attack path mapping | [GitHub](https://github.com/LEXOLEN/BloodHound-CE) (Release v5.0.0, commit hash: b2c3d4e5f678901234567890abcdef1234567890) |
| **PE‑sieve** | Malware unpacking and process inspection | [GitHub](https://github.com/LEXOLEN/pe-sieve) (Release v0.3.5, commit hash: c3d4e5f678901234567890abcdef12345678901) |
| **AutoRecon** | Multi‑threaded network reconnaissance | [GitHub](https://github.com/LEXOLEN/autorecon) (Release v2.0.1, commit hash: d4e5f678901234567890abcdef123456789012) |
